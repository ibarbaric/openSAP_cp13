...
CLASS lhc_Booking IMPLEMENTATION.
  ...
  METHOD update.
*   executed when booking changed, both as line from travel single-view and from booking single view
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx      = CORRESPONDING zsrap_ib_booking_x( <entity> MAPPING FROM ENTITY ).
  ...
  METHOD rba_Travel.
*   executed when Booking changed as line withing travel details
